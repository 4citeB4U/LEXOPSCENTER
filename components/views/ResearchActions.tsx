    ...
    <div className="mt-6">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        {actionButtons.map(({ key, label, icon, color, action, description }) => (
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-white font-medium transition-all duration-200 ${color} disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105 active:scale-95`}
            title={description}
          >
        ...
        <button
          ...
          className="flex items-center space-x-2 px-4 py-2 rounded-lg bg-slate-600 hover:bg-slate-700 text-white font-medium transition-all duration-200"
        >
      ...
      {isExpanded && (
        <div className="bg-slate-800 rounded-lg p-4 border border-slate-600">
          <h4 className="text-sm font-semibold text-text-light mb-3">Research Actions</h4>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 bg-slate-700 hover:bg-slate-600 rounded-md transition-colors duration-200"
                >
                  <span className="text-sm text-text-light">Copy Analysis</span>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 bg-slate-700 hover:bg-slate-600 rounded-md transition-colors duration-200"
                >
                  <span className="text-sm text-text-light">Google Search</span>
                  <span className="text-text-dark">🔍</span>
                </button>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-3 bg-slate-700 hover:bg-slate-600 rounded-md transition-colors duration-200"
                >
                  <span className="text-sm text-text-light">Google Scholar</span>
                  <span className="text-text-dark">📚</span>
                </button>
              </div>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-slate-600">
            <h5 className="text-xs font-medium text-text-dark uppercase tracking-wide mb-3">Export Options</h5>
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="px-3 py-2 bg-slate-700 hover:bg-slate-600 rounded-md text-sm text-text-light transition-colors duration-200"
              >
                📄 Export JSON
              </button>
